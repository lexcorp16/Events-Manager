...
import DisplayHoc from '../../HOC/ModifyCenterPageHoc';
              ...
              <div className="edit-form col-lg-8" style={{ marginTop: '5px' }}>
                <form className="form form-group container edit-label">
                  ...
                  <div className="text-center">
                    <button className="btn btn-default btn-save-m" onClick={this.modifyCenter} >SAVE</button>
...
export default connect(mapStateToProps, mapDispatchToProps)(DisplayHoc(ModifyCenterPage));
