...
const CenterCard = props => (
  <div className="acenter col-lg-4 col-sm-12 col-xs-12 col-md-6 center-card">
    <div
      className="card all-centers-card"
    ...
    >
      <img
        ...
        src={
          props.center.imageUrl !== null
            ? props.center.imageUrl
            : placeholderImage
        }
        alt="Card"
      ...
      <div className="card-body">
        ...
        <p className="card-text date-of-event">
          # <b>{props.center.rentalCost}</b> per day
        </p>
        <div className="card-menu action-buttons">
          <div className="btn-group d-flex justify-content-end">
            {isAdmin() && (
              <button
                className="btn modify-btn center-btn"
                onClick={props.promptModifyCenter}
                id={props.center.id}
              >
                EDIT
              </button>
            ...
            <button
              className="btn edit-btn center-btn detail-btn"
              onClick={props.promptSeeCenter}
              id={props.center.id}
            >
              DETAILS
            </button>
