...
const OneCenterPage = props => (
  <div className="row">
    <div className="col-md-8">
      <img
        className="img-fluid img-oneCenter"
        src={
          props.center.imageUrl !== null ? props.center.imageUrl : placeholder
        }
        alt=""
    ...
    <div className="col-md-4 nav-center text-center">
      ...
      >
        ...
        <button
          type="button"
          className="btn btn-booked-dates"
          data-toggle="modal"
      ...
      {(!isAuthenticated() || !isAdmin()) && (
        <div className="book-event-btn-section">
          <Link to="/addevent">
            <button
              type="button"
              className="btn btn-default btn-block btn-book"
            >
              Book Center Now
            </button>
          </Link>
      ...
      <div className="modal-dialog modal-sm">
        <div className="modal-content">
          ...
          <div className="modal-footer">
            <button
              type="button"
              className="btn btn-default btn-close-f"
              data-dismiss="modal"
            >
              Close
            </button>
    ...
    <div className="modal fade" id="myModal1">
      <div className="modal-dialog modal-lg">
        <div className="modal-content">
          ...
          <div className="modal-body">
            {props.eventStatus.cancellingEvent && <SpinnerProgressBar />}
            <table
              className="table table-striped table-dark table-booked"
              style={{ marginTop: '20px' }}
            >
              <tbody>
                {props.center.venueOfEvent.length === 0 ? (
                  <tr>
                    <td className="text-center">
                      There are currently no event slated for this center
                    </td>
                  </tr>
                ) : (
          ...
          <div className="modal-footer">
            <button
              type="button"
              className="btn btn-default btn-close-b"
              data-dismiss="modal"
            >
              Close
            </button>
