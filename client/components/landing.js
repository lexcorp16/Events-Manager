        ...
        <div className="landing-slide">
          <div className="slideshow-container">
            ...
            <div className="mySlides fade">
              ...
              <img src="../public/images/land2.jpg" className="img img-responsive img-fluid img-one" style={{ width: `${100}%` }} />
            ...
            <div className="mySlides fade">
              ...
              <img src="../public/images/land3.jpg" className="img img-responsive img-fluid img-one" style={{ width: `${100}%` }} />
              <div className="text"><a href="./templates/signup.html"><button className="btn btn-primary slide-up">Discover centers</button></a></div>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-xs-4 col-sm-4 col-lg-4">
              <div className="card img-fluid" style={{ width: `${500}px`, color: 'white' }}>
                <img className="card-img-top card-image imagec-two" src="../public/images/weddin1.jpg" alt="Card image" style={{ width: `${100}%` }} />
            ...
            <div className="col-xs-4 col-sm-4 col-lg-4">
              <div className="card img-fluid" style={{ width: `${500}px`, color: 'white' }}>
                <img className="card-img-top card-image imagec-two" src="../public/images/weddin1.jpg" style={{ width: `${100}%` }} />
                <div className="card-img-overlay">
                  <h4 className="card-title" style={{ color: 'pink' }}>VGC</h4>
                  <p className="card-text">Emerys Wedding Center<br /><a href="./templates/eventcenterdetails.html">see details</a></p>
                </div>
