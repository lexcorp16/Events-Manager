          ...
          {props.eventDetails && (
            <div className="eventDetails">
              ...
              <div className="eventDetails text-center">
                <p>
                  <b>startDate:</b>{' '}
                  {moment(props.eventDetails.startDate).format('DD MMMM YYYY')}
                </p>
                <p>
                  <b>endDate:</b>{' '}
                  {moment(props.eventDetails.endDate).format('DD MMMM YYYY')}
                </p>
                <p>
          ...
          {props.eventDetails.center === null ? (
            <div className="text-center">
              <p style={{ fontFamily: 'Open Sans, sans-serif' }}>
                There is currently no venue for this event
              </p>
              <button
                className="btn btn-nav btn-default btn-add"
                data-dismiss="modal"
                id={props.eventDetails.id}
                onClick={props.navigateToModificationPage}
              >
                ADD CENTER
              </button>
            </div>
            ...
            <div>
              <h4 className="text-center vd-header venueDetails">
                Venue Details
              </h4>
              {!props.venueDetails ? (
                ...
                <div className="venueDetails text-center">
                  <p>
                    <b>Name:</b> {props.venueDetails.name}
                  </p>
                  <p>
                    <b>Rental cost:</b> {props.venueDetails.rentalCost}
                  </p>
                  <p>
                    <b>Capacity:</b> {props.venueDetails.capacity}
                  </p>
                  <p>
                    <b>Address:</b>
                    {props.venueDetails.address}
                  </p>
                  <button
                    className="btn btn-block"
                    id={props.venueDetails.id}
                    data-dismiss="modal"
                    style={{ color: '#C51162' }}
                    onClick={props.navigateToCenterPage}
                  >
                    SEE MORE INFO
                  </button>
                </div>
