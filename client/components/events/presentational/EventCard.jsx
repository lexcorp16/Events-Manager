...
const EventCard = props =>
  (
    <div>
      <div className="acenter col-lg-4 col-sm-12 col-xs-12 col-md-6 center-card" style={{ paddingRight: '30px' }}>
        <div className="card all-centers-card" style={{ marginTop: '30px' }}>
